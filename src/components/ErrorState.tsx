    ...
    <section className="rounded-2xl border border-rose-200 bg-rose-50 p-4 dark:border-rose-900/60 dark:bg-rose-950/25">
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          {details ? <details className="mt-2 text-xs text-rose-700 dark:text-rose-300"><summary className="cursor-pointer font-bold">Details</summary><p className="mt-1 break-words">{details}</p></details> : null}
