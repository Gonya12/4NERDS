  ...
  return <section className="space-y-3">
    <div className="surface-card p-4">
      ...
      <div className="mt-3 grid grid-cols-2 gap-2 sm:grid-cols-4">
        ...
        <div className="rounded-xl bg-slate-100 p-3 dark:bg-slate-900"><small className="block text-slate-500">Sale profit</small><b>{review.grossProfit == null ? "Pending cost basis" : formatMoney(review.grossProfit)}</b></div>
      ...
      {review.outgoing.map((item) => {
        ...
        return <article key={item.id} className="surface-card p-4">
          ...
          <div className="mt-3 grid grid-cols-2 gap-2 text-xs sm:grid-cols-4">
            ...
            <span className="rounded-xl bg-slate-50 p-2 dark:bg-slate-900">Sale profit<br /><b>{profit == null ? "Incomplete" : formatMoney(profit)}</b></span>
