...
export function EventFormPage() {
  ...
  async function save() {
    ...
    const event: Event = {
      ...
      calendarFeedId: existing?.calendarFeedId,
      importedFromCalendar: existing?.importedFromCalendar,
      manuallyEdited: existing?.importedFromCalendar ? true : existing?.manuallyEdited,
