...
const tableChecks: Array<{ table: string; columns: string }> = [
  ...
  },
  {
    ...
    columns: "id,transaction_id,direction,source_inventory_purchase_id,created_inventory_purchase_id,created_sales_record_id,created_business_expense_id,prior_inventory_purchase_id,item_name,item_type,quantity,market_value,agreed_trade_value,trade_percentage,cost_basis,zero_cost_basis_confirmed,sold_price,purchase_price,allocated_cash_amount,image_url,image_path,back_image_url,back_image_path,collector_number,set_name,card_set,card_set_id,card_set_code,card_rarity,card_game,card_language,data_provider,provider_card_id,card_code,pokemon_tcg_card_id,official_card_image_url,tcgplayer_url,market_price_source,market_price_variant,market_price_updated_at,market_price_checked_at,market_price_currency,tcgplayer_pricing,target_buy_percentage,target_buy_price,card_selection_source,cost_basis_is_estimate,card_condition,sticker_price,sticker_condition,grading_company,grade,certificate_number,notes,created_at,updated_at"
  },
  {
