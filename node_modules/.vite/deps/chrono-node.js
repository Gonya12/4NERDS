...
var DETimeUnitAgoFormatParser = class extends AbstractParserWithWordBoundaryChecking {
  ...
  innerPattern() {
    return new RegExp(`(?:\\s*((?:nächste|kommende|folgende|letzte|vergangene|vorige|vor(?:her|an)gegangene)(?:s|n|m|r)?|vor|in)\\s*)?(${NUMBER_PATTERN2})?(?:\\s*(nächste|kommende|folgende|letzte|vergangene|vorige|vor(?:her|an)gegangene)(?:s|n|m|r)?)?\\s*(${matchAnyPattern(TIME_UNIT_DICTIONARY2)})(?=\\W|$)`, "i");
  }
  innerExtract(context, match) {
...
var PATTERN62 = new RegExp(`(?:(?:\\,|\\(|\\（)\\s*)?(?:(viime|edellinen|edellisenä|ensi|seuraava|seuraavana|tämä|tänä)\\s*)?(${matchAnyPattern(WEEKDAY_DICTIONARY11)})(?:\\s*(?:\\,|\\)|\\）))?(?:\\s*(viime|ensi|seuraava)\\s*viikolla)?(?=\\W|$)`, "i");
...
var FITimeUnitWithinFormatParser = class extends AbstractParserWithWordBoundaryChecking {
  innerPattern() {
    return new RegExp(`(${TIME_UNITS_PATTERN10})\\s*(?:sisällä|kuluessa|päästä)(?=\\W|$)`, "i");
  }
  innerExtract(context, match) {
    const timeUnits = parseDuration10(match[1]);
    return ParsingComponents.createRelativeFromReference(context.reference, timeUnits);
...
var PATTERN65 = new RegExp(`(nyt|tänään|huomenna|ylihuomenna|eilen|toissapäivänä|viime\\s*yönä)(?:\\s*(aamulla|aamuna|aamupäivällä|päivällä|iltapäivällä|illalla|yöllä|keskiyöllä))?(?=\\W|$)`, "i");
var DATE_GROUP17 = 1;
var TIME_GROUP3 = 2;
...
var PATTERN66 = new RegExp("(?:ngày\\s*)?([0-9]{1,2})\\s*tháng\\s*([0-9]{1,2})(?:\\s*năm\\s*(" + YEAR_PATTERN10 + "))?(?=\\W|$)", "i");
var DAY_GROUP6 = 1;
var MONTH_GROUP8 = 2;
var YEAR_GROUP27 = 3;
...
var PATTERN71 = new RegExp("(" + matchAnyPattern(WEEKDAY_DICTIONARY12) + ")(?:\\s*(này|tới|sau(?!\\s*khi)|qua))?(?=\\W|$)", "i");
...
var PATTERN72 = new RegExp("(?:lúc\\s*|vào\\s*)?([0-9]{1,2})(?:\\s*giờ\\s*([0-9]{1,2})?\\s*(?:phút\\s*)?(sáng|trưa|chiều|tối|đêm)?|:([0-9]{2}))(?=\\W|$)", "i");
var HOUR_GROUP7 = 1;
...
var PATTERN75 = new RegExp("(?:trong\\s*(?:vòng\\s*)?)(" + TIME_UNITS_PATTERN11 + ")(?=\\W|$)", "i");
...
var PATTERN76 = new RegExp("(này|trước|qua|sau|tới|tiếp)\\s*(" + CASUAL_UNIT_PATTERN + ")|(" + CASUAL_UNIT_PATTERN + ")\\s*(này|trước|qua|sau|tới|tiếp)(?=\\W|$)", "i");
